...
module Dor
  module Releasable
    ...
    #
    #@param array_of_tags [Array] an array of hashes, with the hashes being release tags
    #
    ...
    #@param admin_tags optional [Array] the administrative tags on an item, if not supplied it will attempt to retrieve them
    #
    ...
    #
    #param druid [String], the druid without or without the driud prefix
    #
    ...
    #
    #param new_tags [Hash] a hash of all new tags in the form of { Project => Boolean }, where Project is a string
    #
