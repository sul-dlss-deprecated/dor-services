  ...
  describe '#to_solr' do
    ...
    it 'makes a solr doc' do
      ...
      expect(doc).to match a_hash_including('use_statement_ssim' =>
        ['Rights are owned by Stanford University Libraries. All Rights Reserved. ' \
          'This work is protected by copyright law. No part of the materials may be ' \
          'derived, copied, photocopied, reproduced, translated or reduced to any ' \
