...
describe Dor::GeoMetadataDS do
  ...
  before :each do
    ...
    @doc_misc  = Nokogiri::XML(read_fixture "geoMetadata.xml")
  end

  context 'Terminology' do
    
    it 'xpath' do
      @doc_misc.xpath('//gmd:MD_Metadata', 'xmlns:gmd' => 'http://www.isotc211.org/2005/gmd').first.name.should == 'MD_Metadata'
    end
  ...
  #     end
    ...
    # it 'data' do
    #   puts @doc['co2_pipe'].to_solr_spatial
    ...
    #   puts @doc['oil_gas_fields'].to_solr_spatial
  ...
  context 'Exports' do
    ...
    it '#feature_catalogue' do
      ...
      # @doc['co2_pipe'].feature_catalogue.root.children.size.should == 15
      @doc['co2_pipe'].feature_catalogue.nil?.should == true
      @doc['oil_gas_fields'].feature_catalogue.nil?.should == true
    end
