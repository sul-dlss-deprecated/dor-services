...
describe Dor::SearchService do
  ...
  context "#query_by_id" do
    ...
    it "should perform a solr search" do
      ...
      FakeWeb.register_uri(:get, 'http://dor-dev.stanford.edu/solr/select?facet.field=isMemberOfCollection_id_facet&facet.field=project_tag_facet&facet=on&q=object_type_field:item&rows=2&wt=json', :body => json_response)
