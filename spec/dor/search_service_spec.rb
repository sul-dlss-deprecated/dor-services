...
describe Dor::SearchService do
  ...
  context "indexing functions" do
    before :each do
      ...
      FakeWeb.register_uri(:get, 'https://dor-dev.stanford.edu/gsearch/rest/?action=fromPid&operation=updateIndex&value=druid:bb110sm8219', :body => 'OK')
      FakeWeb.register_uri(:get, 'https://dor-dev.stanford.edu/gsearch/rest/?action=fromPid&operation=updateIndex&value=druid:bb110sm8210', :body => 'OK')
    end
  ...
  context ".query" do
    before :each do
      ...
      FakeWeb.register_uri(:get, "https://dor-dev.stanford.edu/solr/solrizer/select?fl=id&q=dor_id_t%3A%22barcode%3A9191919191%22&rows=14&start=0&wt=ruby", :body => ruby_responses[0])
      FakeWeb.register_uri(:get, "https://dor-dev.stanford.edu/solr/solrizer/select?fl=id&q=dor_id_t%3A%22barcode%3A9191919191%22&rows=14&start=14&wt=ruby", :body => ruby_responses[1])
      FakeWeb.register_uri(:get, "https://dor-dev.stanford.edu/solr/solrizer/select?fl=id&q=dor_id_t%3A%22barcode%3A9191919191%22&rows=14&start=28&wt=ruby", :body => ruby_responses[2])
      FakeWeb.allow_net_connect = false
    end
  ...
  context ".query_by_id" do
    ...
    it "should look up an object based on any of its IDs" do
      ...
      FakeWeb.register_uri(:get, "https://dor-dev.stanford.edu/solr/solrizer/select?fl=id&q=identifier_t%3A%22barcode%3A9191919191%22&rows=1000&start=0&wt=ruby", :body => ruby_responses[0])
      FakeWeb.register_uri(:get, "https://dor-dev.stanford.edu/solr/solrizer/select?fl=id&q=identifier_t%3A%22barcode%3A9191919191%22&rows=1000&start=25&wt=ruby", :body => ruby_responses[1])
    ...
    it "should perform a solr search" do
      ...
      FakeWeb.register_uri(:get, 'https://dor-dev.stanford.edu/solr/gsearch/select?facet=on&facet.field=isMemberOfCollection_id_facet&facet.field=project_tag_facet&q=object_type_field:item&rows=2&wt=json', :body => json_response)
