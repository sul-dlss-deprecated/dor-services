...
describe IdentityMetadata do
  ...
  before :all do
    ...
    @data = {
      ...
      :other_ids => ['barcode:36105049267078', 'catkey:129483625', 'uuid:7f3da130-7b02-11de-8a39-0800200c9a66'],
  ...
  context "build from scratch" do
    ...
    it "should build proper identity metadata XML" do
      ...
      @idm.adminPolicy = @data[:admin_policy]
  ...
  context "read and parse" do
    ...
    it "should load the proper values" do
      ...
      @idm.adminPolicy.should  == @data[:admin_policy]
