...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'stanford-mods', '= 1.5.3'  # v1.5.4 changes what sw_genre returns, which breaks test expectations.
  # TODO: (stanford-mods) figure out how to keep argo indexed counterparts of searchworks fields in sync w/ current SW behavior.
