...
- <b>3.17.9</b> SdrIngestService was not handling case when object has no contentMetadata.
                Also now extracts all datastreams from Fedora even if file exists on disk.
== Copyright
