...
- <br>3.12.0</b> Added some update services for identity metadata, rights metadata, and desc metadata 
- <br>3.12.2</b> Autoload the TechnicalMetadataService whenever dor-services is required
== Copyright
